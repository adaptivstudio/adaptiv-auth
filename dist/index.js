...
__decorateClass([
  (0, import_swagger.ApiProperty)({ type: [UserResponseDto] })
], PaginatedUsersResponseDto.prototype, "data", 2);
__decorateClass([
  (0, import_swagger.ApiProperty)({ description: "Total number of matching users", example: 42 })
], PaginatedUsersResponseDto.prototype, "total", 2);
__decorateClass([
  (0, import_swagger.ApiProperty)({ description: "Number of records skipped", example: 0 })
], PaginatedUsersResponseDto.prototype, "skip", 2);
__decorateClass([
  (0, import_swagger.ApiProperty)({ description: "Number of records returned", example: 20 })
...
__decorateClass([
  ...
  (0, import_swagger2.ApiOperation)({ summary: "Create a new user" }),
  (0, import_swagger2.ApiResponse)({ status: 201, description: "User created", type: UserResponseDto }),
  (0, import_swagger2.ApiResponse)({ status: 409, description: "Email or username already in use" }),
  __decorateParam(0, (0, import_common2.Body)())
], UsersController.prototype, "create", 1);
__decorateClass([
  (0, import_common2.Get)(),
  (0, import_swagger2.ApiOperation)({ summary: "List users with optional pagination and search" }),
  (0, import_swagger2.ApiResponse)({ status: 200, description: "Paginated user list", type: PaginatedUsersResponseDto }),
  __decorateParam(0, (0, import_common2.Query)())
], UsersController.prototype, "list", 1);
__decorateClass([
  (0, import_common2.Get)(":id"),
  (0, import_swagger2.ApiOperation)({ summary: "Get a user by ID" }),
  (0, import_swagger2.ApiParam)({ name: "id", description: "User ID" }),
  (0, import_swagger2.ApiResponse)({ status: 200, description: "User found", type: UserResponseDto }),
  (0, import_swagger2.ApiResponse)({ status: 404, description: "User not found" }),
  __decorateParam(0, (0, import_common2.Param)("id"))
], UsersController.prototype, "findOne", 1);
__decorateClass([
  (0, import_common2.Patch)(":id"),
  (0, import_swagger2.ApiOperation)({ summary: "Update a user" }),
  (0, import_swagger2.ApiParam)({ name: "id", description: "User ID" }),
  (0, import_swagger2.ApiResponse)({ status: 200, description: "User updated", type: UserResponseDto }),
  (0, import_swagger2.ApiResponse)({ status: 404, description: "User not found" }),
  __decorateParam(0, (0, import_common2.Param)("id")),
...
__decorateClass([
  ...
  (0, import_swagger2.ApiOperation)({ summary: "Delete a user" }),
  (0, import_swagger2.ApiParam)({ name: "id", description: "User ID" }),
  (0, import_swagger2.ApiResponse)({ status: 204, description: "User deleted" }),
  (0, import_swagger2.ApiResponse)({ status: 404, description: "User not found" }),
  __decorateParam(0, (0, import_common2.Param)("id"))
], UsersController.prototype, "remove", 1);
UsersController = __decorateClass([
  (0, import_swagger2.ApiTags)("users"),
...
__decorateClass([
  (0, import_swagger3.ApiProperty)({ description: "Short-lived JWT access token" })
], TokenResponseDto.prototype, "accessToken", 2);
__decorateClass([
  (0, import_swagger3.ApiProperty)({ description: "Long-lived opaque refresh token" })
], TokenResponseDto.prototype, "refreshToken", 2);
__decorateClass([
  (0, import_swagger3.ApiProperty)({ type: UserResponseDto, required: false })
], TokenResponseDto.prototype, "user", 2);
var RefreshResponseDto = class {
};
__decorateClass([
  (0, import_swagger3.ApiProperty)({ description: "New short-lived JWT access token" })
], RefreshResponseDto.prototype, "accessToken", 2);
__decorateClass([
  (0, import_swagger3.ApiProperty)({ description: "New long-lived opaque refresh token (rotated)" })
...
__decorateClass([
  ...
  (0, import_swagger4.ApiOperation)({ summary: "Login with email/username and password" }),
  (0, import_swagger4.ApiResponse)({ status: 200, description: "Login successful", type: TokenResponseDto }),
  (0, import_swagger4.ApiResponse)({ status: 401, description: "Invalid credentials" }),
...
__decorateClass([
  ...
  (0, import_common8.HttpCode)(import_common8.HttpStatus.OK),
  (0, import_swagger4.ApiOperation)({ summary: "Rotate a refresh token and obtain new token pair" }),
  (0, import_swagger4.ApiResponse)({ status: 200, description: "Tokens refreshed", type: RefreshResponseDto }),
  (0, import_swagger4.ApiResponse)({ status: 401, description: "Invalid or expired refresh token" }),
  __decorateParam(0, (0, import_common8.Body)())
...
__decorateClass([
  ...
  (0, import_swagger4.ApiOperation)({ summary: "Revoke a single refresh token" }),
  (0, import_swagger4.ApiResponse)({ status: 204, description: "Logged out" }),
  __decorateParam(0, (0, import_common8.Body)())
...
__decorateClass([
  ...
  (0, import_common8.HttpCode)(import_common8.HttpStatus.NO_CONTENT),
  (0, import_swagger4.ApiBearerAuth)(),
  (0, import_swagger4.ApiOperation)({ summary: "Revoke all refresh tokens for the current user" }),
  (0, import_swagger4.ApiResponse)({ status: 204, description: "All sessions terminated" }),
  __decorateParam(0, CurrentUser())
], AuthController.prototype, "logoutAll", 1);
AuthController = __decorateClass([
  (0, import_swagger4.ApiTags)("auth"),
...
__decorateClass([
  ...
  (0, import_swagger5.ApiOperation)({ summary: "Request a password reset email" }),
...
__decorateClass([
  ...
  (0, import_swagger5.ApiOperation)({ summary: "Validate a password reset token" }),
  (0, import_swagger5.ApiParam)({ name: "token", description: "Password reset token" }),
  (0, import_swagger5.ApiResponse)({ status: 200, description: "Token is valid" }),
  (0, import_swagger5.ApiResponse)({ status: 400, description: "Token is invalid or expired" }),
...
__decorateClass([
  ...
  (0, import_common13.HttpCode)(import_common13.HttpStatus.OK),
  (0, import_swagger5.ApiOperation)({ summary: "Reset password using a valid token" }),
  (0, import_swagger5.ApiResponse)({ status: 200, description: "Password reset successfully" }),
  (0, import_swagger5.ApiResponse)({ status: 400, description: "Invalid or expired token" }),
  __decorateParam(0, (0, import_common13.Body)())
], PasswordRecoveryController.prototype, "resetPassword", 1);
PasswordRecoveryController = __decorateClass([
  (0, import_swagger5.ApiTags)("password-recovery"),
...
__decorateClass([
  (0, import_swagger6.ApiProperty)({ description: "Permission ID", example: "clxyz789" })
], _PermissionResponseDto.prototype, "id", 2);
__decorateClass([
  (0, import_swagger6.ApiProperty)({ description: "Permission key", example: "posts:create" })
], _PermissionResponseDto.prototype, "key", 2);
__decorateClass([
  (0, import_swagger6.ApiPropertyOptional)({ description: "Permission description", example: "Create new posts", nullable: true })
], _PermissionResponseDto.prototype, "description", 2);
__decorateClass([
  (0, import_swagger6.ApiProperty)({ description: "Creation timestamp" })
...
__decorateClass([
  ...
  (0, import_swagger7.ApiOperation)({ summary: "Create a new permission" }),
  (0, import_swagger7.ApiResponse)({ status: 201, description: "Permission created", type: PermissionResponseDto }),
  (0, import_swagger7.ApiResponse)({ status: 409, description: "Permission key already exists" }),
  __decorateParam(0, (0, import_common16.Body)())
], PermissionsController.prototype, "create", 1);
__decorateClass([
  (0, import_common16.Get)(),
  (0, import_swagger7.ApiOperation)({ summary: "List all permissions" }),
  (0, import_swagger7.ApiResponse)({ status: 200, description: "List of permissions", type: [PermissionResponseDto] })
], PermissionsController.prototype, "list", 1);
__decorateClass([
  (0, import_common16.Get)(":id"),
  (0, import_swagger7.ApiOperation)({ summary: "Get a permission by ID" }),
  (0, import_swagger7.ApiParam)({ name: "id", description: "Permission ID" }),
  (0, import_swagger7.ApiResponse)({ status: 200, description: "Permission found", type: PermissionResponseDto }),
  (0, import_swagger7.ApiResponse)({ status: 404, description: "Permission not found" }),
...
__decorateClass([
  ...
  (0, import_swagger7.ApiOperation)({ summary: "Delete a permission" }),
  (0, import_swagger7.ApiParam)({ name: "id", description: "Permission ID" }),
  (0, import_swagger7.ApiResponse)({ status: 204, description: "Permission deleted" }),
  (0, import_swagger7.ApiResponse)({ status: 404, description: "Permission not found" }),
  __decorateParam(0, (0, import_common16.Param)("id"))
], PermissionsController.prototype, "remove", 1);
__decorateClass([
  (0, import_common16.Post)("roles/:roleId/assign"),
  (0, import_swagger7.ApiOperation)({ summary: "Assign a permission to a role" }),
  (0, import_swagger7.ApiParam)({ name: "roleId", description: "Role ID" }),
  (0, import_swagger7.ApiResponse)({ status: 201, description: "Permission assigned to role" }),
  (0, import_swagger7.ApiResponse)({ status: 404, description: "Permission not found" }),
...
__decorateClass([
  ...
  (0, import_common16.HttpCode)(import_common16.HttpStatus.NO_CONTENT),
  (0, import_swagger7.ApiOperation)({ summary: "Remove a permission from a role" }),
  (0, import_swagger7.ApiParam)({ name: "roleId", description: "Role ID" }),
  (0, import_swagger7.ApiParam)({ name: "permissionId", description: "Permission ID" }),
  (0, import_swagger7.ApiResponse)({ status: 204, description: "Permission removed from role" }),
  __decorateParam(0, (0, import_common16.Param)("roleId")),
...
__decorateClass([
  ...
  (0, import_swagger7.ApiOperation)({ summary: "Get all permissions for a role" }),
  (0, import_swagger7.ApiParam)({ name: "roleId", description: "Role ID" }),
  (0, import_swagger7.ApiResponse)({ status: 200, description: "Role permissions", type: [PermissionResponseDto] }),
  __decorateParam(0, (0, import_common16.Param)("roleId"))
], PermissionsController.prototype, "getRolePermissions", 1);
__decorateClass([
  (0, import_common16.Get)("users/:userId"),
  (0, import_swagger7.ApiOperation)({ summary: "Get all resolved permissions for a user (across all roles)" }),
  (0, import_swagger7.ApiParam)({ name: "userId", description: "User ID" }),
  (0, import_swagger7.ApiResponse)({ status: 200, description: "User permissions", type: [PermissionResponseDto] }),
...
PermissionsController = __decorateClass([
  (0, import_swagger7.ApiTags)("permissions"),
  (0, import_swagger7.ApiBearerAuth)(),
...
__decorateClass([
  (0, import_swagger8.ApiProperty)({ description: "Profile ID", example: "clxyzabc" })
], _ProfileResponseDto.prototype, "id", 2);
__decorateClass([
  (0, import_swagger8.ApiProperty)({ description: "User ID this profile belongs to", example: "clxyz123" })
], _ProfileResponseDto.prototype, "userId", 2);
__decorateClass([
  (0, import_swagger8.ApiPropertyOptional)({ description: "First name", example: "John", nullable: true })
], _ProfileResponseDto.prototype, "firstName", 2);
__decorateClass([
  (0, import_swagger8.ApiPropertyOptional)({ description: "Last name", example: "Doe", nullable: true })
], _ProfileResponseDto.prototype, "lastName", 2);
__decorateClass([
  (0, import_swagger8.ApiPropertyOptional)({ description: "Avatar URL", example: "https://example.com/avatar.png", nullable: true })
], _ProfileResponseDto.prototype, "avatarUrl", 2);
__decorateClass([
  (0, import_swagger8.ApiProperty)({ description: "Extensible metadata", example: {} })
], _ProfileResponseDto.prototype, "metadata", 2);
__decorateClass([
  (0, import_swagger8.ApiProperty)({ description: "Creation timestamp" })
], _ProfileResponseDto.prototype, "createdAt", 2);
__decorateClass([
  (0, import_swagger8.ApiProperty)({ description: "Last update timestamp" })
...
__decorateClass([
  ...
  (0, import_swagger9.ApiOperation)({ summary: "Get the profile for a user" }),
  (0, import_swagger9.ApiParam)({ name: "userId", description: "User ID" }),
  (0, import_swagger9.ApiResponse)({ status: 200, description: "Profile found", type: ProfileResponseDto }),
  (0, import_swagger9.ApiResponse)({ status: 404, description: "Profile not found" }),
  __decorateParam(0, (0, import_common19.Param)("userId"))
], ProfilesController.prototype, "findOne", 1);
__decorateClass([
  (0, import_common19.Patch)(),
  (0, import_swagger9.ApiOperation)({ summary: "Create or update the profile for a user" }),
  (0, import_swagger9.ApiParam)({ name: "userId", description: "User ID" }),
  (0, import_swagger9.ApiResponse)({ status: 200, description: "Profile upserted", type: ProfileResponseDto }),
  __decorateParam(0, (0, import_common19.Param)("userId")),
  __decorateParam(1, (0, import_common19.Body)())
], ProfilesController.prototype, "upsert", 1);
ProfilesController = __decorateClass([
  (0, import_swagger9.ApiTags)("profiles"),
  (0, import_swagger9.ApiBearerAuth)(),
...
__decorateClass([
  (0, import_swagger10.ApiProperty)({ description: "Role ID", example: "clxyz456" })
], _RoleResponseDto.prototype, "id", 2);
__decorateClass([
  (0, import_swagger10.ApiProperty)({ description: "Role name", example: "admin" })
], _RoleResponseDto.prototype, "name", 2);
__decorateClass([
  (0, import_swagger10.ApiPropertyOptional)({ description: "Role description", example: "Full system access", nullable: true })
], _RoleResponseDto.prototype, "description", 2);
__decorateClass([
  (0, import_swagger10.ApiProperty)({ description: "Creation timestamp" })
...
__decorateClass([
  ...
  (0, import_swagger11.ApiOperation)({ summary: "Create a new role" }),
  (0, import_swagger11.ApiResponse)({ status: 201, description: "Role created", type: RoleResponseDto }),
  (0, import_swagger11.ApiResponse)({ status: 409, description: "Role name already exists" }),
  __decorateParam(0, (0, import_common22.Body)())
], RolesController.prototype, "create", 1);
__decorateClass([
  (0, import_common22.Get)(),
  (0, import_swagger11.ApiOperation)({ summary: "List all roles" }),
  (0, import_swagger11.ApiResponse)({ status: 200, description: "List of roles", type: [RoleResponseDto] })
], RolesController.prototype, "list", 1);
__decorateClass([
  (0, import_common22.Get)(":id"),
  (0, import_swagger11.ApiOperation)({ summary: "Get a role by ID" }),
  (0, import_swagger11.ApiParam)({ name: "id", description: "Role ID" }),
  (0, import_swagger11.ApiResponse)({ status: 200, description: "Role found", type: RoleResponseDto }),
  (0, import_swagger11.ApiResponse)({ status: 404, description: "Role not found" }),
...
__decorateClass([
  ...
  (0, import_swagger11.ApiOperation)({ summary: "Delete a role" }),
  (0, import_swagger11.ApiParam)({ name: "id", description: "Role ID" }),
  (0, import_swagger11.ApiResponse)({ status: 204, description: "Role deleted" }),
  (0, import_swagger11.ApiResponse)({ status: 404, description: "Role not found" }),
  __decorateParam(0, (0, import_common22.Param)("id"))
], RolesController.prototype, "remove", 1);
__decorateClass([
  (0, import_common22.Post)("users/:userId/assign"),
  (0, import_swagger11.ApiOperation)({ summary: "Assign a role to a user" }),
  (0, import_swagger11.ApiParam)({ name: "userId", description: "User ID" }),
  (0, import_swagger11.ApiResponse)({ status: 201, description: "Role assigned" }),
  (0, import_swagger11.ApiResponse)({ status: 404, description: "Role not found" }),
...
__decorateClass([
  ...
  (0, import_common22.HttpCode)(import_common22.HttpStatus.NO_CONTENT),
  (0, import_swagger11.ApiOperation)({ summary: "Remove a role from a user" }),
  (0, import_swagger11.ApiParam)({ name: "userId", description: "User ID" }),
  (0, import_swagger11.ApiParam)({ name: "roleId", description: "Role ID" }),
  (0, import_swagger11.ApiResponse)({ status: 204, description: "Role removed from user" }),
  __decorateParam(0, (0, import_common22.Param)("userId")),
...
__decorateClass([
  ...
  (0, import_swagger11.ApiOperation)({ summary: "Get all roles for a user" }),
  (0, import_swagger11.ApiParam)({ name: "userId", description: "User ID" }),
  (0, import_swagger11.ApiResponse)({ status: 200, description: "User roles", type: [RoleResponseDto] }),
  __decorateParam(0, (0, import_common22.Param)("userId"))
], RolesController.prototype, "getUserRoles", 1);
RolesController = __decorateClass([
  (0, import_swagger11.ApiTags)("roles"),
  (0, import_swagger11.ApiBearerAuth)(),
...
__decorateClass([
  (0, import_swagger12.ApiProperty)({ description: "Account password", example: "S3cret!Pass" }),
  (0, import_class_validator.IsString)(),
  (0, import_class_validator.IsNotEmpty)()
...
__decorateClass([
  (0, import_swagger13.ApiProperty)({ description: "The refresh token issued at login", example: "abc123..." }),
...
__decorateClass([
  (0, import_swagger14.ApiProperty)({ description: "User email address", example: "john@example.com" }),
  (0, import_class_validator3.IsEmail)()
], CreateUserDto.prototype, "email", 2);
__decorateClass([
  (0, import_swagger14.ApiPropertyOptional)({ description: "Unique username", example: "johndoe" }),
  (0, import_class_validator3.IsOptional)(),
  (0, import_class_validator3.IsString)()
], CreateUserDto.prototype, "username", 2);
__decorateClass([
  (0, import_swagger14.ApiProperty)({ description: "Plain-text password (will be hashed)", example: "S3cret!Pass" }),
  (0, import_class_validator3.IsString)(),
...
__decorateClass([
  (0, import_swagger15.ApiPropertyOptional)({ description: "New email address", example: "new@example.com" }),
  (0, import_class_validator4.IsOptional)(),
  (0, import_class_validator4.IsEmail)()
], UpdateUserDto.prototype, "email", 2);
__decorateClass([
  (0, import_swagger15.ApiPropertyOptional)({ description: "New username", example: "janedoe" }),
  (0, import_class_validator4.IsOptional)(),
  (0, import_class_validator4.IsString)()
], UpdateUserDto.prototype, "username", 2);
__decorateClass([
  (0, import_swagger15.ApiPropertyOptional)({ description: "Whether the account is active", example: true }),
  (0, import_class_validator4.IsOptional)(),
...
__decorateClass([
  (0, import_swagger16.ApiPropertyOptional)({ description: "Number of records to skip", example: 0, default: 0 }),
...
__decorateClass([
  (0, import_swagger16.ApiPropertyOptional)({ description: "Number of records to return", example: 20, default: 20 }),
  (0, import_class_validator5.IsOptional)(),
  (0, import_class_transformer.Type)(() => Number),
  (0, import_class_validator5.IsInt)(),
...
__decorateClass([
  (0, import_swagger16.ApiPropertyOptional)({ description: "Search by email or username", example: "john" }),
  (0, import_class_validator5.IsOptional)(),
...
__decorateClass([
  (0, import_swagger17.ApiPropertyOptional)({ description: "First name", example: "John" }),
  (0, import_class_validator6.IsOptional)(),
  (0, import_class_validator6.IsString)()
], UpdateProfileDto.prototype, "firstName", 2);
__decorateClass([
  (0, import_swagger17.ApiPropertyOptional)({ description: "Last name", example: "Doe" }),
  (0, import_class_validator6.IsOptional)(),
  (0, import_class_validator6.IsString)()
], UpdateProfileDto.prototype, "lastName", 2);
__decorateClass([
  (0, import_swagger17.ApiPropertyOptional)({ description: "Avatar URL", example: "https://example.com/avatar.png" }),
  (0, import_class_validator6.IsOptional)(),
  (0, import_class_validator6.IsUrl)()
], UpdateProfileDto.prototype, "avatarUrl", 2);
__decorateClass([
  (0, import_swagger17.ApiPropertyOptional)({
...
__decorateClass([
  (0, import_swagger18.ApiProperty)({ description: "Unique role name", example: "admin" }),
  (0, import_class_validator7.IsString)(),
  (0, import_class_validator7.IsNotEmpty)()
], CreateRoleDto.prototype, "name", 2);
__decorateClass([
  (0, import_swagger18.ApiPropertyOptional)({ description: "Role description", example: "Full system access" }),
...
__decorateClass([
  (0, import_swagger19.ApiProperty)({ description: "ID of the role to assign", example: "clxyz456" }),
...
__decorateClass([
  (0, import_swagger20.ApiPropertyOptional)({ description: "Permission description", example: "Create new posts" }),
...
__decorateClass([
  (0, import_swagger21.ApiProperty)({ description: "ID of the permission to assign", example: "clxyz789" }),
...
__decorateClass([
  (0, import_swagger22.ApiProperty)({ description: "Email address to send the reset link to", example: "john@example.com" }),
...
__decorateClass([
  (0, import_swagger23.ApiProperty)({ description: "The password reset token received via email", example: "abc123..." }),
  (0, import_class_validator12.IsString)(),
  (0, import_class_validator12.IsNotEmpty)()
], ResetPasswordDto.prototype, "token", 2);
__decorateClass([
  (0, import_swagger23.ApiProperty)({ description: "The new password", example: "N3wS3cret!" }),
  (0, import_class_validator12.IsString)(),
  (0, import_class_validator12.IsNotEmpty)(),
...
function setupAdaptivAuthSwagger(app, options) {
  ...
  const config = new import_swagger24.DocumentBuilder().setTitle(title).setVersion(version).addBearerAuth(
    { type: "http", scheme: "bearer", bearerFormat: "JWT" },
    bearerName
  ).build();
  const document = import_swagger24.SwaggerModule.createDocument(app, config);
  import_swagger24.SwaggerModule.setup(path, app, document);
}
