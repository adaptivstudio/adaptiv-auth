...
__decorateClass([
  ApiProperty2({ type: () => [UserResponseDto] })
], PaginatedUsersResponseDto.prototype, "data", 2);
__decorateClass([
  ApiProperty2({ description: "Total number of matching users", example: 42 })
], PaginatedUsersResponseDto.prototype, "total", 2);
__decorateClass([
  ApiProperty2({ description: "Number of records skipped", example: 0 })
], PaginatedUsersResponseDto.prototype, "skip", 2);
__decorateClass([
  ApiProperty2({ description: "Number of records returned", example: 20 })
...
__decorateClass([
  ApiProperty3({ description: "Short-lived JWT access token" })
], TokenResponseDto.prototype, "accessToken", 2);
__decorateClass([
  ApiProperty3({ description: "Long-lived opaque refresh token" })
], TokenResponseDto.prototype, "refreshToken", 2);
__decorateClass([
  ApiProperty3({ type: () => UserResponseDto, required: false })
], TokenResponseDto.prototype, "user", 2);
var RefreshResponseDto = class {
};
__decorateClass([
  ApiProperty3({ description: "New short-lived JWT access token" })
], RefreshResponseDto.prototype, "accessToken", 2);
__decorateClass([
  ApiProperty3({ description: "New long-lived opaque refresh token (rotated)" })
...
import { ApiProperty as ApiProperty4, ApiPropertyOptional as ApiPropertyOptional2 } from "@nestjs/swagger";
...
__decorateClass([
  ApiProperty4({ description: "Permission ID", example: "clxyz789" })
], _PermissionResponseDto.prototype, "id", 2);
__decorateClass([
  ApiProperty4({ description: "Permission key", example: "posts:create" })
...
__decorateClass([
  ApiProperty5({ description: "Profile ID", example: "clxyzabc" })
], _ProfileResponseDto.prototype, "id", 2);
__decorateClass([
  ApiProperty5({ description: "User ID this profile belongs to", example: "clxyz123" })
...
__decorateClass([
  ApiProperty5({ description: "Extensible metadata", example: {}, type: Object })
...
__decorateClass([
  ApiProperty5({ description: "Last update timestamp" })
...
__decorateClass([
  ApiProperty6({ description: "Role ID", example: "clxyz456" })
], _RoleResponseDto.prototype, "id", 2);
__decorateClass([
  ApiProperty6({ description: "Role name", example: "admin" })
...
__decorateClass([
  ApiProperty6({ description: "Creation timestamp" })
...
__decorateClass([
  ApiProperty7({ description: "Account password", example: "S3cret!Pass" }),
  IsString(),
  IsNotEmpty()
...
__decorateClass([
  ApiProperty8({ description: "The refresh token issued at login", example: "abc123..." }),
  IsString2(),
  IsNotEmpty2()
...
__decorateClass([
  ApiProperty9({ description: "User email address", example: "john@example.com" }),
  IsEmail()
...
__decorateClass([
  ApiProperty9({ description: "Plain-text password (will be hashed)", example: "S3cret!Pass" }),
  IsString3(),
  IsNotEmpty3(),
  MinLength(8)
...
import { ApiProperty as ApiProperty10, ApiPropertyOptional as ApiPropertyOptional9 } from "@nestjs/swagger";
...
__decorateClass([
  ApiProperty10({ description: "Unique role name", example: "admin" }),
  IsString7(),
  IsNotEmpty4()
...
__decorateClass([
  ApiProperty11({ description: "ID of the role to assign", example: "clxyz456" }),
  IsString8(),
  IsNotEmpty5()
], AssignRoleDto.prototype, "roleId", 2);

// src/permissions/dto/create-permission.dto.ts
import { ApiProperty as ApiProperty12, ApiPropertyOptional as ApiPropertyOptional10 } from "@nestjs/swagger";
...
__decorateClass([
  ApiProperty13({ description: "ID of the permission to assign", example: "clxyz789" }),
  IsString10(),
  IsNotEmpty7()
...
__decorateClass([
  ApiProperty14({ description: "Email address to send the reset link to", example: "john@example.com" }),
  IsEmail3()
...
__decorateClass([
  ApiProperty15({ description: "The password reset token received via email", example: "abc123..." }),
  IsString11(),
  IsNotEmpty8()
], ResetPasswordDto.prototype, "token", 2);
__decorateClass([
  ApiProperty15({ description: "The new password", example: "N3wS3cret!" }),
  IsString11(),
  IsNotEmpty8(),
  MinLength2(8)
