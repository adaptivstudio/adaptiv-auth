...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new permission', operationId: 'createPermission' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List all permissions', operationId: 'listPermissions' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get a permission by ID', operationId: 'getPermissionById' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete a permission', operationId: 'deletePermission' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Permission ID' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Assign a permission to a role', operationId: 'assignPermissionToRole' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get all permissions for a role', operationId: 'getRolePermissions' }),
    (0, swagger_1.ApiParam)({ name: 'roleId', description: 'Role ID' }),
