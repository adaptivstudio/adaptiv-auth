...
__decorate([
    (0, swagger_1.ApiProperty)({ type: Number, description: 'Total number of matching users', example: 42 }),
    __metadata("design:type", Number)
], PaginatedUsersResponseDto.prototype, "total", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ type: Number, description: 'Number of records skipped', example: 0 }),
    __metadata("design:type", Number)
], PaginatedUsersResponseDto.prototype, "skip", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ type: Number, description: 'Number of records returned', example: 20 }),
    __metadata("design:type", Number)
