...
exports.RefreshResponseDto = exports.TokenResponseDto = void 0;
...
__decorate([
    (0, swagger_1.ApiProperty)({ type: String, description: 'Short-lived JWT access token' }),
    __metadata("design:type", String)
], TokenResponseDto.prototype, "accessToken", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ type: String, description: 'Long-lived opaque refresh token' }),
    __metadata("design:type", String)
], TokenResponseDto.prototype, "refreshToken", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ type: () => user_response_dto_1.UserResponseDto, required: false }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ type: String, description: 'New short-lived JWT access token' }),
    __metadata("design:type", String)
], RefreshResponseDto.prototype, "accessToken", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ type: String, description: 'New long-lived opaque refresh token (rotated)' }),
    __metadata("design:type", String)
