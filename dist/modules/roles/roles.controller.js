...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new role', operationId: 'createRole' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List all roles', operationId: 'listRoles' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get a role by ID', operationId: 'getRoleById' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete a role', operationId: 'deleteRole' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Role ID' }),
